...
context: fork
maxTurns: 50
skills: [api-design, database-migrations, android-clean-architecture, kotlin-coroutines-flows, laravel-specialist, python-design-patterns, python-testing-patterns, golang-pro, dotnet-backend-patterns, django-patterns, docker-expert]
effort: max
---
