...
- The project-native registry process indexes skills; it must not summarize or rewrite them, and any tool with automatic commit behavior requires an explicit preflight check.
