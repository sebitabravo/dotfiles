...
description: SOLID principles applied, composition over inheritance, layered separation (controller/service/repository), and design principles (YAGNI, KISS, polymorphism over conditionals, tell-dont-ask). Use when designing a module, reviewing architecture, deciding between inheritance and composition, or refactoring a class with too many responsibilities.
---
